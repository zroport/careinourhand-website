...
export function ContactPageHero({ pageHeader }: ContactPageHeroProps = {}) {
  const heading = pageHeader?.heading
  const subheading =
    pageHeader?.subheading ?? "Have a question or want to learn more? We'd love to hear from you."
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {heading ? (
          ...
          <h1
            ...
            className="text-4xl sm:text-5xl font-bold text-white leading-[1.1] tracking-tight mb-5 max-w-2xl"
          >
            Contact <span className="text-[#c8e87a]">Us</span>
          </h1>
        )}
